...
export default function LoginPage() {
  ...
  const { login, isLoading, error, user, checkAuth, clearError } =
    useAuthStore();
    ...
    <div className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-mesh px-4">
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in-up">
        ...
        <div className="mb-8 flex flex-col items-center">
          <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-accent-500 to-glow-violet shadow-glow">
            <MessageSquare className="h-7 w-7 text-white" />
          </div>
          <h1 className="text-2xl font-bold text-gradient">Welcome back</h1>
          <p className="mt-1 text-sm text-surface-400">
            Sign in to continue to DevChat
          </p>
        </div>
